...
namespace Projeto.Presentation
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DataContext>(d => d.UseSqlServer(Configuration.GetConnectionString("ProjetoDDD02")));
            ...
            services.AddTransient<IFornecedorDomainService, FornecedorDomainSerivce>();
